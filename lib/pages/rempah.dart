...
class _RempahState extends State<Rempah> {
  ...
  Future<List<Vegetable>> fetchVegetables() async {
    final response1 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=ginger&apiKey=$apiKey&number=20&offset=0'),
    );
    final response2 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=garlic&apiKey=$apiKey&number=20&offset=0'),
    );
    final response3 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=onion&apiKey=$apiKey&number=20&offset=0'),
    );
    final response4 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=shallot&apiKey=$apiKey&number=20&offset=0'),
    );
    if (response1.statusCode == 200 && response2.statusCode == 200 && response2.statusCode == 200 && response4.statusCode == 200) {
    ...
    final List jsonResponse4 = json.decode(response4.body)['results'];


    List combinedResults = [...jsonResponse1, ...jsonResponse2, ...jsonResponse3, ...jsonResponse4];
