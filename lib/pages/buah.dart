...
class _BuahState extends State<Buah> {
  ...
  Future<List<Vegetable>> fetchVegetables() async {
    final response1 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=apple&apiKey=$apiKey&number=20&offset=0'),
    );
    final response2 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=orange&apiKey=$apiKey&number=20&offset=0'),
    );
    final response3 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=banana&apiKey=$apiKey&number=20&offset=0'),
    );
    final response4 = await http.get(
      Uri.parse(
          'https://api.spoonacular.com/food/ingredients/search?query=mango&apiKey=$apiKey&number=20&offset=0'),
    );
